...
# ALTER TABLE REGISTER_CLASS3 ADD PRIMARY KEY (REGISTER_ID,LECTURE_ID);#FFFFFFFFFF
...
#
# ALTER TABLE REGISTER_CLASS3 ADD CONSTRAINT FK_REGISTER_CLASSFOREIGN1 FOREIGN KEY (LECTURE_ID) REFERENCES LECTURE_INFO(LECTURE_ID);
# ALTER TABLE REGISTER_CLASS3 ADD CONSTRAINT FK_REGISTER_CLASSFOREIGN2 FOREIGN KEY (STDT_ID) REFERENCES STDT_INFO(STDT_ID);
#
# ALTER TABLE ASSIGNMENT_SUBMIT ADD CONSTRAINT FK_LECTURE_ID FOREIGN KEY (LECTURE_ID) REFERENCES REGISTER_CLASS3(LECTURE_ID);
# ALTER TABLE ACADEMIC_RECORD ADD CONSTRAINT FK_LECTURE_ID_ACA FOREIGN KEY (LECTURE_ID) REFERENCES REGISTER_CLASS3(LECTURE_ID);
#
# # --------------
#
#
